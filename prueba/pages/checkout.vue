    ...
    <section class="cart-wrapper">
        <div class="cart">
            ...
            <div class="list-wrapper">
                <h2>Que beneficios voy a tener?</h2>
                <ul class="comprando-list">
                    <li class="list-items">
                        <i class="fas fa-check"></i>
                        <span>Asistencia en 24 horas</span>
                    </li>
                    <li class="list-items">
                        <i class="fas fa-check"></i>
                        <span>Planes al menor precio</span>
                    </li>
                    <li class="list-items">
                        <i class="fas fa-check"></i>
                        <span>Experiencia de más de 30 años</span>
                    </li>
        ...
        <div class="form">
            ...
            <div class="paypal-checkout" v-if="store.paypalPopUP">
                <i class="fas fa-close" @click="store.paypalPopUP = false"></i>
                <CartPaypal />
            </div>
            <CartCheckoutCard v-else />
