          ...
          <div class="login__content">
            ...
            <form class="login__form" @submit.prevent="register">
              ...
              <BaseInput v-model="formLogin.idDocument" :v="vuelidate.idDocument" label="Identificación" for="id"
                :has-icon="true">
                <template #img>
                  <img src="~/assets/images/ico-png-grupo-1-78px_0000_Layer-1-datos.png" alt="User icon" />
                </template>
              </BaseInput>
              <BaseInput v-model="formLogin.email" :v="vuelidate.email" label="Email" for="email"
                :has-icon="true">
                <template #img>
                  <img src="~/assets/images/email-green.png" alt="Email icon" />
                </template>
              </BaseInput>
              <BaseInput v-model="formLogin.establecimientos" :v="vuelidate.establecimientos" label="Establecimientos" for="establecimientos"
                :has-icon="true">
                <template #img>
                  <img src="~/assets/images/establecimientosimg.png" alt="User icon" />
                </template>
              </BaseInput>
              <BaseInput v-model="formLogin.password" :v="vuelidate.password" label="Contraseña" for="password"
                ...
                <template #img>
                  <img src="~/assets/images/ico-png-grupo-1-78px_0001_Layer-2-compromiso.png" alt="Left icon" />
                </template>
              </BaseInput>
