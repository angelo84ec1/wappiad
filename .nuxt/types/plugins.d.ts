...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/toastification.client").default> &
  InjectionType<typeof import("../../plugins/gsap.client").default> &
  InjectionType<typeof import("../../plugins/pinia-persist.client").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:revive-payload:server' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin' | 'nuxt:chunk-reload' | 'nuxt:checkIfLayoutUsed'
  }
}
